...
},{"./ChatForm.jsx":161,"./ChatMsgLst.jsx":163,"./UserList.jsx":165,"jquery":28,"react":159}],161:[function(require,module,exports){
var React = require('react');
...
var ChatForm = React.createClass({displayName: "ChatForm",
	...
	render: function() {
		return (
			React.createElement("div", {id: "sendMsgFormHolder"}, 
				React.createElement("form", {className: "form-inline", role: "form", onSubmit: this.handelSubmit}, 
					React.createElement("div", {className: "form-group"}, 
						React.createElement("input", {className: "form-control", style: {width:"70%"}, type: "text", placeholder: this.props.chatTo ? "對" + this.props.chatTo + "說" : "訊息", onChange: this.handelMessage, value: this.state.text}), 
						React.createElement("button", {className: "btn btn-primary", style: {width:"30%"}, type: "submit"}, "Send")
					)
				)
			)
		);
...
},{"./ChatMsg.jsx":162,"react":159}],164:[function(require,module,exports){
var React = require('react');
...
},{"./User.jsx":164,"react":159}],166:[function(require,module,exports){
var $ = require("jquery");
var React = require('react');
	...
	render: function() {
	      return (
	          	React.createElement("div", {className: "row full-height"}, 
	          		...
	          		React.createElement("div", {id: "chat-room", className: "col-md-2 full-height"}, 
