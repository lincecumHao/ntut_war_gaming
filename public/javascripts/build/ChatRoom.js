...
var index = React.createClass({displayName: "index",
	...
	render: function() {
		var strTime = this.props.systemTime.getHours() + ":" + this.props.systemTime.getMinutes() + ":" + this.props.systemTime.getSeconds();

		return (
			React.createElement("div", {id: "situation", class: "row"}, 
			  React.createElement("div", {class: "col-md-12 situation"}, 
			    React.createElement("h3", {class: "situation_step"}, this.props.step), 
			    React.createElement("h3", {class: "situation_description"}, this.props.description), 
			    React.createElement("div", {id: "system_time"}, strTime)
			  )
			)
		);
	}
...
ReactDOM.render(
	...
	document.getElementById('situation_wrapper')
);

},{"./top.jsx":162,"react":159,"react-dom":30}],162:[function(require,module,exports){
var $ = require("jquery");
var React = require("react");
var situation = require("./Situation/index.jsx")
var socket = io();
var _map;
...
var top = React.createClass({displayName: "top",
	...
	render: function() {
		return (
			React.createElement("situation", {
				step: this.props.situation.step, 
				description: this.props.situation.description, 
...
},{"./Situation/index.jsx":160,"jquery":28,"react":159}]},{},[161]);
