  ...
  _valueChange: function(e){
	...
	render: function() {
		return (
			...
			<div className="row">
				<div className="footer-initial border-bottom">{this.props.currentTotalSend}</div>
				...
				<br/>
  			<input type="number" min="0" max={this.props.departMaxResource} value={this.props.send} onChange={this._valueChange}/>
			</div>
			</div>
		);
	}
